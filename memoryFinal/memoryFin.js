...
function toggle(e) // e est l'argument de notre fonction (event)
...
//fonction permettant de lancer notre jeux à partir
//de la fonction game 
function jouer()
{
const buttonPlay = document.getElementById("btnReplay")
